...
public class ADManager : Singleton<ADManager>, IManager
{
    ...
    //激励视频播放结果
    public Action<bool> RewardPlayEventHandler, RewardShutDownEventHandler;
    /// <summary>
    /// 当前使用中的广告适配器
    /// </summary>
    ...
    public bool IsPlayReward { get; private set; }
...
#else
        RewardPlayEventHandler?.Invoke(true);
#endif
    }
    ...
    private void OnApplicationPause(bool pause)
    {
        ...
        //if (UseBackgroundAD && !pause && !IsPlayReward && CanShowInterstitial())
        //    ShowFullScreen();
    }
}
