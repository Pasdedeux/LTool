...
{   
    public class GTextFieldAdapter : CrossBindingAdaptor
    {
        static CrossBindingFunctionInfo<System.String> mget_text_0 = new CrossBindingFunctionInfo<System.String>("get_text");
        static CrossBindingMethodInfo<System.String> mset_text_1 = new CrossBindingMethodInfo<System.String>("set_text");
        static CrossBindingMethodInfo mSetTextFieldText_2 = new CrossBindingMethodInfo("SetTextFieldText");
        static CrossBindingMethodInfo mHandleSizeChanged_3 = new CrossBindingMethodInfo("HandleSizeChanged");
        static CrossBindingMethodInfo<FairyGUI.Utils.ByteBuffer, System.Int32> mSetup_BeforeAdd_4 = new CrossBindingMethodInfo<FairyGUI.Utils.ByteBuffer, System.Int32>("Setup_BeforeAdd");
        ...
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FairyGUI.GTextField);
            }
        }
        ...
        public class Adapter : FairyGUI.GTextField, CrossBindingAdaptorType
        {
            ...
            {
                if (mSetTextFieldText_2.CheckShouldInvokeBase(this.instance))
                    base.SetTextFieldText();
                else
                    mSetTextFieldText_2.Invoke(this.instance);
            }

            protected override void HandleSizeChanged()
            {
                if (mHandleSizeChanged_3.CheckShouldInvokeBase(this.instance))
                    base.HandleSizeChanged();
                else
                    mHandleSizeChanged_3.Invoke(this.instance);
            }

            public override void Setup_BeforeAdd(FairyGUI.Utils.ByteBuffer buffer, System.Int32 beginPos)
            {
                if (mSetup_BeforeAdd_4.CheckShouldInvokeBase(this.instance))
                    base.Setup_BeforeAdd(buffer, beginPos);
                else
                    mSetup_BeforeAdd_4.Invoke(this.instance, buffer, beginPos);
            }
            ...
            get
            {
                if (mget_text_0.CheckShouldInvokeBase(this.instance))
                    return base.text;
                else
                    return mget_text_0.Invoke(this.instance);

            }
            set
            {
                if (mset_text_1.CheckShouldInvokeBase(this.instance))
                    base.text = value;
                else
                    mset_text_1.Invoke(this.instance, value);
