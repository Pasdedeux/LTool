...
* 项目描述 ：
* 类 名 称 ：AdapterChuanShanjia
* 类 描 述 ：
* 命名空间 ：LitFramework.ThirdParty.AD
* 机器名称 ：DEREK-SURFACEPR 
* CLR 版本 ：4.0.30319.42000
* 作    者 ：LHW
* 创建时间 ：2021/2/19 15:52:15
* 版 本 号 ：v1.0.0.0
*******************************************************************
...
public class AdapterChuanShanjia : BaseAdAdapter
{
    ...
    {
#if CSJ
            _adapter = new ChuanShanjia( this );
#endif
    ...
    {
#if CSJ
            //_adapter.LoadNativeIntersititialAd();
            _adapter.LoadFullScreenVideoAd();
            //_adapter.LoadExpressFullScreenVideoAd();
#endif
    }
    ...
    public override bool IsIntersititialReady()
    {
        return true;
#if UNITY_IOS && CSJ
            return _adapter.iExpressInterstitialAd != null;
#elif UNITY_ANDROID && CSJ
            return _adapter.mExpressInterstitialAd != null;
#else
        return false;
#endif
    }
    ...
    public override bool IsRewardedVideoAvailable()
    {
        return true;
#if UNITY_IOS && CSJ
            return _adapter.expressRewardAd != null;
#elif UNITY_ANDROID && CSJ
            return _adapter.rewardAd != null;
#else
        return false;
#endif
    }
    ...
    {
#if CSJ
            return _adapter != null && _adapter.adNative != null;
#else
        return false;
#endif
    }
    ...
    {
#if CSJ
            //_adapter.ShowNativeIntersititialAd();
            _adapter.ShowFullScreenVideoAd();
            //_adapter.ShowExpressFullScreenVideoAd();
#endif
    }
    ...
    {
        Debug.Log("InitBannerCallBack");
    }

    protected override void InitInterstitialCallBack()
    {
        Debug.Log("InitInterstitialCallBack");
    }

    protected override void InitRewardedCallBack()
    {
        Debug.Log("InitRewardedCallBack");
    }
}
    ...
    /// </summary>
    public sealed class ChuanShanjia : MonoBehaviour
    {
        public RewardVideoAd rewardAd;
        public AdNative adNative;

        public string appID = "5119686";
        public string initialID = "945611057";
#if HOTCLOUD
        //买量包
        public string rewardID = "945611059";
#else
        //渠道包
        public string rewardID = "945685047";
#endif
...
#if UNITY_IOS
    public ExpressRewardVideoAd expressRewardAd; // for iOS
    public ExpressFullScreenVideoAd expressFullScreenVideoAd; // for iOS
    public ExpressBannerAd iExpressBannerAd; // for iOS
    public ExpressInterstitialAd iExpressInterstitialAd; // for iOS
#else

#endif

        public ExpressAd mExpressFeedad;
        public ExpressAd mExpressBannerAd;
        public ExpressAd mExpressInterstitialAd;

        public AdapterChuanShanjia adapterParent;

        public ChuanShanjia( AdapterChuanShanjia mng )
        {
            adapterParent = mng;
        }

        public void ShowRewardEventResult( bool succ )
        {
            adapterParent.RewardShowEventHandler?.Invoke( succ );
        }

        public void ShowInitialRewardEventHandler( bool succ )
        {
            adapterParent.InterstitialShowEventHandler?.Invoke( succ );
        }
        ...
        public void LoadRewardAd()
        {
            ...
            string iosSlotID = rewardID;
            string AndroidSlotID = rewardID;
            //// 横屏
            //if ( this.getScreenOrientationConfig() == 1 )
            //{
            //    iosSlotID = "945543255";
            //    AndroidSlotID = "945543255";
            //}
        ...
        public void LoadFullScreenVideoAd()
        {
            ...
            string iosSlotID = initialID;
            string AndroidSlotID = initialID;
            //// 横屏
            //if ( this.getScreenOrientationConfig() == 1 )
            //{
            //    iosSlotID = "945543259";
            //    AndroidSlotID = "945543259";
            //}
       ...
       if (bannerAd == null)
        ...
        {
            private ChuanShanjia example;

            public RewardVideoAdListener( ChuanShanjia example )
            {
            ...
            {
                Debug.LogWarning( "OnRewardError: " + message );
        ...
        private sealed class ExpressRewardVideoAdListener : IRewardVideoAdListener
        {
            ...
            public ExpressRewardVideoAdListener( ChuanShanjia example )
            {
                this.example = example;
            }
        ...
        private sealed class FullScreenVideoAdListener : IFullScreenVideoAdListener
        {
            ...
            public FullScreenVideoAdListener( ChuanShanjia example )
            {
                this.example = example;
            }
            ...
            public void OnError( int code, string message )
            {
                Debug.LogWarning( "OnFullScreenError: " + message );
        ...
        private sealed class ExpressFullScreenVideoAdListener : IFullScreenVideoAdListener
        {
            ...
            public ExpressFullScreenVideoAdListener( ChuanShanjia example )
            {
                this.example = example;
            }
       ...
       if (this.example.expressFullScreenVideoAd != null)
        ...
        private sealed class ExpressAdListener : IExpressAdListener
        {
            ...
            public ExpressAdListener( ChuanShanjia example, int type )
            {
                this.example = example;
                this.type = type;
        ...
        private sealed class ExpressAdInteractionListener : IExpressAdInteractionListener
        {
            ...
            public ExpressAdInteractionListener( ChuanShanjia example, int type )
            {
                this.example = example;
                this.type = type;
            }
            ...
            public void OnAdClose( ExpressAd ad )
            {
                ...
                example.ShowInitialRewardEventHandler( true );
        ...
        private sealed class ExpressAdDislikeCallback : IDislikeInteractionListener
        {
            ...
            public ExpressAdDislikeCallback( ChuanShanjia example, int type )
            {
                this.example = example;
                this.type = type;
            }
        ...
        private sealed class NativeAdInteractionListener : IInteractionAdInteractionListener
        {
            private ChuanShanjia example;
            int type;//0:feed   1:banner
            public NativeAdInteractionListener( ChuanShanjia example, int type )
            {
                this.example = example;
            }
        ...
        private sealed class NativeAdListener : INativeAdListener
        {
            ...
            public NativeAdListener( ChuanShanjia example )
            {
                this.example = example;
            }
        ...
        private sealed class FullScreenAdInteractionListener : IFullScreenVideoAdInteractionListener
        {
            ...
            public FullScreenAdInteractionListener( ChuanShanjia example )
            {
                this.example = example;
            }
            ...
            public void OnAdShow()
            {
                ...
                example.adapterParent.CreateInterstitial();
            }
        ...
        private sealed class RewardAdInteractionListener : IRewardAdInteractionListener
        {
            ...
            public RewardAdInteractionListener( ChuanShanjia example )
            {
                this.example = example;
            }
            ...
            public void OnAdShow()
            {
                ...
                example.adapterParent.CreateRewarded();
            }
...
#endif
                example.ShowRewardEventResult( true );
                example.adapterParent.CreateRewarded();
            }
                ...
                bool rewardVerify, int rewardAmount, string rewardName )
            {
                ...
                //example.ShowRewardEventResult( rewardVerify );
                //this.example.information.text ="verify:" + rewardVerify + " amount:" + rewardAmount + " name:" + rewardName;
            }
        }
        ...
        private sealed class SplashAdListener : ISplashAdListener
        {
            ...
            public SplashAdListener( ChuanShanjia example )
            {
                this.example = example;
            }

            public SplashAdListener( ChuanShanjia example, AndroidJavaObject activity, AndroidJavaObject splashAdManager )
            {
                this.example = example;
            ...
            private sealed class SplashAdInteractionListener : ISplashAdInteractionListener
            {
                ...
                private AndroidJavaObject activity;
                private AndroidJavaObject splashAdManager;
                public SplashAdInteractionListener( ChuanShanjia example )
                {
                    this.example = example;
                }

                public SplashAdInteractionListener( ChuanShanjia example, AndroidJavaObject activity, AndroidJavaObject splashAdManager )
                {
                    this.example = example;
                    this.activity = activity;
                    this.splashAdManager = splashAdManager;
        ...
        private sealed class ExpressSplashAdListener : ISplashAdListener
        {
            ...
            public ExpressSplashAdListener( ChuanShanjia example )
            {
                this.example = example;
            }
        ...
        private sealed class ExpressSplashAdInteractionListener : ISplashAdInteractionListener
        {
            ...
            public ExpressSplashAdInteractionListener( ChuanShanjia example )
            {
                this.example = example;
            }
        ...
        private sealed class AppDownloadListener : IAppDownloadListener
        {
            ...
            public AppDownloadListener( ChuanShanjia example )
            {
                this.example = example;
            }
