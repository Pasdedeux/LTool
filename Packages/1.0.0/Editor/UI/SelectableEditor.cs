...
namespace UnityEditor.UI
{
    ...
    public class SelectableEditor : Editor
    {
        ...
        SerializedProperty m_TargetTransProperty;
        ...
        SerializedProperty m_IsExportProperty;
        ...
        AnimBool m_ShowScale = new AnimBool();
        ...
        protected virtual void OnEnable()
        {
            ...
            m_TargetTransProperty   = serializedObject.FindProperty("m_TargetTrans");
            m_IsExportProperty = serializedObject.FindProperty("IsExport");
            ...
            m_PropertyPathToExcludeForChildClasses = new[]
            {
                ...
                m_TargetTransProperty.propertyPath,
                m_IsExportProperty.propertyPath,
            };

            var trans = GetTransition(m_TransitionProperty);
            m_ShowColorTint.value       = (trans == Selectable.Transition.ColorTint);
            m_ShowScale.value = (trans == Selectable.Transition.Scale);
            ...
            m_ShowScale.valueChanged.AddListener(Repaint);
        ...
        protected virtual void OnDisable()
        {
            ...
            m_ShowScale.valueChanged.RemoveListener(Repaint);
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_IsExportProperty);
            ...
            var transTarget= m_TargetTransProperty.objectReferenceValue as Transform;
            if (!transTarget)
                transTarget = selectable.transform;
            ...
            m_ShowScale.target = (!m_TransitionProperty.hasMultipleDifferentValues && trans == Button.Transition.Scale);
            ...
            {
                if (trans == Selectable.Transition.ColorTint|| trans == Selectable.Transition.Scale)
                {
                    EditorGUILayout.PropertyField(m_TargetTransProperty);
                }
                ...
                if (EditorGUILayout.BeginFadeGroup(m_ShowScale.faded))
                {
