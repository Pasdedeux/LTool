...
{
    unsafe class AnimationManager_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::AnimationManager);
            args = new Type[]{typeof(UnityEngine.Transform)};
            method = type.GetMethod("GetAllAnim", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetAllAnim_0);
            args = new Type[]{typeof(DG.Tweening.DOTweenAnimation[]), typeof(System.String)};
            method = type.GetMethod("Restart", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Restart_1);
            args = new Type[]{typeof(DG.Tweening.DOTweenAnimation[]), typeof(System.String), typeof(System.Action)};
            method = type.GetMethod("Restart", flag, null, args, null);
        ...
        static StackObject* GetAllAnim_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = global::AnimationManager.GetAllAnim(@root);
        ...
        static StackObject* Restart_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DG.Tweening.DOTweenAnimation[] @animArray = (DG.Tweening.DOTweenAnimation[])typeof(DG.Tweening.DOTweenAnimation[]).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);


            global::AnimationManager.Restart(@animArray, @id);
        ...
        static StackObject* Restart_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            global::AnimationManager.Restart(@animArray, @id, @callBack);
