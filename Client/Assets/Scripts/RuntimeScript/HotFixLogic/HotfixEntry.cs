...
namespace LHotfixProject
{
    public class HotfixEntry
    {
        ...
        {
            Log.TraceInfo( ">>>>执行预加载或初始化", LogColor.yellow );
        ...
        {
            //记得完成相关CLR绑定以及适配器制作
            Log.TraceInfo( string.Format( "《《《 --- {0} version v1.0.0 --- 》》》", FrameworkConfig.Instance.scriptEnvironment == RunEnvironment.DotNet ? "DotNet" : "HotFix" ), LogColor.yellow );
        }
    }
}
