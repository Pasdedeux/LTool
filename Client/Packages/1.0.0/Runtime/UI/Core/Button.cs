...
namespace UnityEngine.UI
{
    ...
    public class Button : Selectable, IPointerClickHandler, ISubmitHandler
    {
        [Header("按钮点击音量")]
        [Range(0,100)]
        public int m_BtnVolume = 100;
        [Header("按钮点击音频")]
        public AudioClip m_BtnAudio;
        [Serializable]
        /// <summary>
        ...
        protected override void Awake()
        {
            ...
            if (m_BtnVolume == 100)
            {
                m_BtnVolume = UGUIDefaultConfig.DefaultVolume;
            }
            if (m_BtnAudio == null)
            {
                m_BtnAudio = UGUIDefaultConfig.DefaultAudioClip;
            }
            if (m_BtnAudio != null)
            {
                m_OnClick.AddListener(PlayAudio);
            }
        }
        /// <summary>
        /// 播放按钮音效
        ...
        {
            UGUIDefaultConfig.PlayAudio.Invoke(m_BtnAudio,m_BtnVolume);
        }
