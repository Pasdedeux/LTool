...
{   
    public class GTreeAdapter : CrossBindingAdaptor
    {
        static CrossBindingMethodInfo<FairyGUI.GObject, FairyGUI.EventContext> mDispatchItemEvent_0 = new CrossBindingMethodInfo<FairyGUI.GObject, FairyGUI.EventContext>("DispatchItemEvent");
        ...
        static CrossBindingMethodInfo<FairyGUI.Utils.ByteBuffer> mReadItems_2 = new CrossBindingMethodInfo<FairyGUI.Utils.ByteBuffer>("ReadItems");
        ...
        static CrossBindingMethodInfo mHandleSizeChanged_6 = new CrossBindingMethodInfo("HandleSizeChanged");
        ...
        static CrossBindingFunctionInfo<System.Int32> mGetFirstChildInView_8 = new CrossBindingFunctionInfo<System.Int32>("GetFirstChildInView");
        class GetSnappingPositionWithDir_9Info : CrossBindingMethodInfo
        {
            ...
            public GetSnappingPositionWithDir_9Info()
        ...
        static GetSnappingPositionWithDir_9Info mGetSnappingPositionWithDir_9 = new GetSnappingPositionWithDir_9Info();
        static CrossBindingMethodInfo mUpdateBounds_10 = new CrossBindingMethodInfo("UpdateBounds");
        ...
        public class Adapter : FairyGUI.GTree, CrossBindingAdaptorType
        {
            ...
            {
                if (mDispatchItemEvent_0.CheckShouldInvokeBase(this.instance))
                    base.DispatchItemEvent(item, context);
                else
                    mDispatchItemEvent_0.Invoke(this.instance, item, context);
            }
            ...
            {
                if (mReadItems_2.CheckShouldInvokeBase(this.instance))
                    base.ReadItems(buffer);
                else
                    mReadItems_2.Invoke(this.instance, buffer);
            }
            ...
            {
                if (mHandleSizeChanged_6.CheckShouldInvokeBase(this.instance))
                    base.HandleSizeChanged();
                else
                    mHandleSizeChanged_6.Invoke(this.instance);
            }
            ...
            {
                if (mGetFirstChildInView_8.CheckShouldInvokeBase(this.instance))
                    return base.GetFirstChildInView();
                else
                    return mGetFirstChildInView_8.Invoke(this.instance);
            }
            ...
            {
                if (mGetSnappingPositionWithDir_9.CheckShouldInvokeBase(this.instance))
                    base.GetSnappingPositionWithDir(ref xValue, ref yValue, xDir, yDir);
                else
                    mGetSnappingPositionWithDir_9.Invoke(this.instance, ref xValue, ref yValue, xDir, yDir);
            }

            protected override void UpdateBounds()
            {
                if (mUpdateBounds_10.CheckShouldInvokeBase(this.instance))
                    base.UpdateBounds();
                else
                    mUpdateBounds_10.Invoke(this.instance);
            }
