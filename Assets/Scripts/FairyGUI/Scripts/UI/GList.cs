...
namespace FairyGUI
{
    ...
    public class GList : GComponent
    {
        ...
        /// </summary>
        public bool foldInvisibleItems = true;
        ...
        public GObject GetToIndexItem(int index)
        {
            if (index >= 0 && index < this.numItems)
            {
                if (selectionMode != ListSelectionMode.Single)
                    ClearSelection();
                GObject obj=AddSelection(index, false);
                return obj;
            }
            else
                ClearSelection();
        ...
        public GObject AddSelection(int index, bool scrollItToView)
        {
            ...
            if (selectBtn != null && !selectBtn.selected)
            {
