...
{   
    public class GRichTextFieldAdapter : CrossBindingAdaptor
    {
        ...
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FairyGUI.GRichTextField);
            }
        }
        ...
        public class Adapter : FairyGUI.GRichTextField, CrossBindingAdaptorType
        {
