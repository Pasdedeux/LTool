...
namespace UnityEditor.UI
{
    ...
    public class DropdownEditor : SelectableEditor
    {
        ...
        SerializedProperty m_DropDownVolumeProperty;
        SerializedProperty m_DropItemVolumeProperty;
        SerializedProperty m_DropDownAudioProperty;
        SerializedProperty m_DropItemAudioProperty;
        ...
        protected override void OnEnable()
        {
            ...
            m_DropDownVolumeProperty = serializedObject.FindProperty("m_DropDownVolume");
            m_DropItemVolumeProperty = serializedObject.FindProperty("m_DropItemVolume");
            m_DropDownAudioProperty = serializedObject.FindProperty("m_DropDownAudio");
            m_DropItemAudioProperty = serializedObject.FindProperty("m_DropItemAudio");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.PropertyField(m_DropDownVolumeProperty);
            EditorGUILayout.PropertyField(m_DropItemVolumeProperty);
            EditorGUILayout.PropertyField(m_DropDownAudioProperty);
            EditorGUILayout.PropertyField(m_DropItemAudioProperty);
            EditorGUILayout.Space();
