...
{   
    public class GRootAdapter : CrossBindingAdaptor
    {
        ...
        static CrossBindingFunctionInfo<System.Int32> mGetFirstChildInView_3 = new CrossBindingFunctionInfo<System.Int32>("GetFirstChildInView");
        ...
        static CrossBindingMethodInfo mUpdateBounds_7 = new CrossBindingMethodInfo("UpdateBounds");
        class GetSnappingPositionWithDir_8Info : CrossBindingMethodInfo
        {
            ...
            public GetSnappingPositionWithDir_8Info()
        ...
        static GetSnappingPositionWithDir_8Info mGetSnappingPositionWithDir_8 = new GetSnappingPositionWithDir_8Info();
        static CrossBindingMethodInfo mOnUpdate_9 = new CrossBindingMethodInfo("OnUpdate");
        static CrossBindingMethodInfo mConstructFromResource_10 = new CrossBindingMethodInfo("ConstructFromResource");
        static CrossBindingMethodInfo<FairyGUI.Utils.ByteBuffer> mConstructExtension_11 = new CrossBindingMethodInfo<FairyGUI.Utils.ByteBuffer>("ConstructExtension");
        static CrossBindingMethodInfo<FairyGUI.Utils.XML> mConstructFromXML_12 = new CrossBindingMethodInfo<FairyGUI.Utils.XML>("ConstructFromXML");
        static CrossBindingMethodInfo<FairyGUI.Utils.ByteBuffer, System.Int32> mSetup_AfterAdd_13 = new CrossBindingMethodInfo<FairyGUI.Utils.ByteBuffer, System.Int32>("Setup_AfterAdd");
        ...
        public class Adapter : FairyGUI.GRoot, CrossBindingAdaptorType
        {
            ...
            {
                if (mGetFirstChildInView_3.CheckShouldInvokeBase(this.instance))
                    return base.GetFirstChildInView();
                else
                    return mGetFirstChildInView_3.Invoke(this.instance);
            }
            ...
            {
                if (mUpdateBounds_7.CheckShouldInvokeBase(this.instance))
                    base.UpdateBounds();
                else
                    mUpdateBounds_7.Invoke(this.instance);
            }
            ...
            {
                if (mGetSnappingPositionWithDir_8.CheckShouldInvokeBase(this.instance))
                    base.GetSnappingPositionWithDir(ref xValue, ref yValue, xDir, yDir);
                else
                    mGetSnappingPositionWithDir_8.Invoke(this.instance, ref xValue, ref yValue, xDir, yDir);
            }
            ...
            {
                if (mConstructFromResource_10.CheckShouldInvokeBase(this.instance))
                    base.ConstructFromResource();
                else
                    mConstructFromResource_10.Invoke(this.instance);
            }

            protected override void ConstructExtension(FairyGUI.Utils.ByteBuffer buffer)
            {
                if (mConstructExtension_11.CheckShouldInvokeBase(this.instance))
                    base.ConstructExtension(buffer);
                else
                    mConstructExtension_11.Invoke(this.instance, buffer);
            }

            public override void ConstructFromXML(FairyGUI.Utils.XML xml)
            {
                if (mConstructFromXML_12.CheckShouldInvokeBase(this.instance))
                    base.ConstructFromXML(xml);
                else
                    mConstructFromXML_12.Invoke(this.instance, xml);
            }

            public override void Setup_AfterAdd(FairyGUI.Utils.ByteBuffer buffer, System.Int32 beginPos)
            {
                if (mSetup_AfterAdd_13.CheckShouldInvokeBase(this.instance))
                    base.Setup_AfterAdd(buffer, beginPos);
                else
                    mSetup_AfterAdd_13.Invoke(this.instance, buffer, beginPos);
            }
