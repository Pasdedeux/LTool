...
namespace SQLite
{
	...
	public class SQLiteConnection : IDisposable
	{
		...
		///// <summary>
		///// Retrieves the mapping that is automatically generated for the given name.
		///// </summary>
		///// <param name="name">
		///// The type whose mapping to the database is returned.
		///// </param>
		...
		//	TableMapping map;
		//	if (!_mappings.TryGetValue(typeName, out map)) return null;
		...
		public int Insert (object obj, out long rowID)
		{
			...
			return Insert (obj, "", obj.GetType (), out rowID);
		}
		...
		public int Insert (object obj, string extra, out long rowID)
		{
			...
			return Insert (obj, extra, obj.GetType (), out rowID);
		}
	...
	public class SQLiteCommand
	{
        ...
        public SQLDataTable ExecuteQueryGeneric()
        {
            if (_conn.Trace)
            {
                Debug.Log("Executing Query: " + this);
