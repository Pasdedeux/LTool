...
namespace UnityEditor.UI
{
    ...
    public class ImageEditor : GraphicEditor
    {
        ...
        SerializedProperty m_ImageSizeType;
        ...
        protected override void OnEnable()
        {
            ...
            m_ImageSizeType= serializedObject.FindProperty("ImageSizeType");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(base.m_IsExport);
            SpriteGUI();
            ...
            EditorGUILayout.EndFadeGroup();
            if ((typeEnum == Image.Type.Simple || typeEnum == Image.Type.Filled) && m_Sprite.objectReferenceValue != null)
            {
                EditorGUILayout.PropertyField(m_ImageSizeType);
            }
            NativeSizeButtonGUI();
