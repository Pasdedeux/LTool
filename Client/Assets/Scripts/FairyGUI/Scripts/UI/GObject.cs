...
namespace FairyGUI
{
    public class GObject : EventDispatcher
    {
        ...
        {
            get { return _name; }
            set { _name = value;gameObjectName = value; }
        }
        ...
        /// </summary>
        /// <param name="restraint">Add relations to maintain the center state.</param>
        public void Bottom(bool restraint)
        {
            GComponent r;
            if (parent != null)
                r = parent;
            ...
            this.SetXY((int)((r.width - this.width) / 2), (int)((r.height - this.height)), true);
            if (restraint)
            {
                this.AddRelation(r, RelationType.Center_Center);
                this.AddRelation(r, RelationType.Bottom_Bottom);
            }
        }
        ...
        virtual public void HandleVisibleChanged()
        {
            if (displayObject != null)
